...
Effector.simulate = function(dt) {
  var avoidanceCount, cohesionCount, diff, diffSq, effector1, effector2, effectors, entity1, entity2, i, imitationCount, impulse, j;
  ...
  while (i--) {
    ...
    while (j--) {
      ...
      if (diffSq < effector1.radiusSq) {
        ...
        Vec2.add(impulse, Vec2.scal(Vec2.sub(entity1.pos, entity2.pos, avoidance), 2));
      }
    }
    if (cohesionCount) {
      if (cohesionCount > 1) {
