...
var Body, Box, Color, Component, Compound, Engine, Explosion, GameController, Pool, Renderer, Spark, Vec2,
...
Compound = require('../../lib/core/compound');
...
Box.Prefab = new Compound.Prefab({
  transform: null,
  bounds: {
    shape: 'circle',
    radius: 10
...
Explosion.Prefab = new Compound.Prefab({
  transform: null,
  explosion: null
});
...
Spark.Prefab = new Compound.Prefab({
  transform: null,
  bounds: {
    shape: 'circle',
    radius: 0.1
...
Engine.gameScene = Compound.alloc(null, {
  gameController: null
});
...
},{"../../lib/core/math":2,"../../lib/core/engine":3,"../../lib/core/renderer":4,"../../lib/core/compound":5,"../../lib/core/component":6,"../../lib/core/pool":7,"../../lib/core/color":8,"../../lib/core/transform":9,"../../lib/core/border":10,"../../lib/vendor/b2/body":11}],2:[function(require,module,exports){var Mat, Vec2, abs, epsilon, fn, i, objCache, objVecCache, pow, powIn, radCache, random, sqrt, toInOut, toOut, transition, typedArray, _i, _len, _ref;
...
},{}],3:[function(require,module,exports){var Compound, Engine, Pool, Vec2, engine, perf, requestAnimationFrame,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"./compound":5,"./pool":7,"./math":2,"./console":12,"./input":13}],4:[function(require,module,exports){var Bounds, Color, Compound, Renderer, Vec2,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"./compound":5,"./bounds":14,"./math":2,"./color":8}],5:[function(require,module,exports){var Compound, Pool;
...
Compound = (function() {
  ...
  Compound.prototype.toString = function() {
    ...
    return "Compound " + (this.name || '') + "#" + this.uid + " (" + comps + ") [^ " + this.parent + "]";
  };

  Compound.prototype.alloc = function(presets) {
  ...
  Compound.prototype.free = function() {
  ...
  Compound.prototype.enable = function(state, deep) {
    var key;
  ...
  Compound.prototype.sub = function(scope, topic, method) {
    var items, refs, subs;
    if (scope == null) {
      scope = this;
    }
  ...
  Compound.prototype.pub = function(topic, a0, a1, a2, a3) {
    var i, items, scope;
  ...
  Compound.prototype.pubUp = function(topic, a0, a1, a2, a3) {
    var comp;
    comp = this;
    while (comp) {
  ...
  Compound.prototype.pubAll = function(topic, a0, a1, a2, a3) {
    return Pool.call(topic, a0, a1, a2, a3);
  };

  Compound.prototype.unsub = function(unscope, untopic) {
...
Compound.Prefab = (function() {
  ...
  Prefab.prototype.alloc = function(parent, presets) {
    ...
    return Compound.alloc(parent, presets || defaults);
  };
...
},{"./pool":7}],7:[function(require,module,exports){var Pool, fn, _i, _len, _ref;
...
Pool = (function() {
  ...
  function Pool(cls) {
    ...
    this.isComponent = this.type && this.type !== 'compound';
...
},{"./math":2}],6:[function(require,module,exports){var Component;
...
},{"./math":2}],8:[function(require,module,exports){var Color, typedArray;
...
},{"./math":2}],9:[function(require,module,exports){var Component, Pool, Transform, Vec2,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"./component":6,"./pool":7,"./math":2}],11:[function(require,module,exports){var B2, Body, Component, Pool, Vec2, empty, impulseCache, manifoldCache, pointCache,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
Body = (function(_super) {
  ...
  Body.prototype.reset = function(presets) {
    ...
    this.fixed = fixed = presets.fixed;
...
},{"./../../core/component":6,"./../../core/pool":7,"./../../core/math":2,"./b2":15}],10:[function(require,module,exports){var Border, Component, Engine, Pool, Vec2, pos,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"./component":6,"./pool":7,"./math":2,"./engine":3}],12:[function(require,module,exports){var Component, Console, Engine, Pool, Vec2,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
Console = (function(_super) {
  ...
  Console.prototype.reset = function(presets) {
    ...
    this.css = presets.css, this.container = presets.container, this.width = presets.width, this.height = presets.height, this.cap = presets.cap, this.resolution = presets.resolution;
...
},{"./component":6,"./pool":7,"./math":2,"./engine":3}],13:[function(require,module,exports){var Component, Engine, Input, Pool, Vec2,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"./component":6,"./pool":7,"./math":2,"./engine":3}],14:[function(require,module,exports){var Bounds, BoundsDebug, Color, Component, Pool, Vec2,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"./component":6,"./pool":7,"./color":8,"./math":2}],15:[function(require,module,exports){var Box2D;
...
},{"./lib/box2dweb":16}],16:[function(require,module,exports){(function(){/*
