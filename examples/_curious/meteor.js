...
var Collider, Color, Entity, Body, Meteor, Registry, Transform, Vec2,
...
Meteor = (function(_super) {
  ...
  Meteor.prototype.create = function(pos, radius, mass) {
    ...
    for (i = _i = 0, _ref = steps - 1; _i <= _ref; i = _i += 1) {
      ...
      point = Vec2.rotate(Vec2(0, 1), rad);
      Vec2.scale(point, Math.rand(radiusMin, radiusMax));
